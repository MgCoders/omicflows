...
import coop.magnesium.db.entities.WorkflowIn;
...
public class RabixCwlTest {
    ...
    public void commandLineToolTest() throws IOException {
        ...
        String jsonCwl = YamlUtils.cwlFileContentToJson(YamlUtils.readFile(file.getPath(), StandardCharsets.UTF_8));
    ...
    public void toolEchoToWorkflow() throws Exception {
        ...
        String jsonCompileToolFile = YamlUtils.cwlFileContentToJson(YamlUtils.readFile(compileToolFile.getPath(), StandardCharsets.UTF_8));
    ...
    public void toolsToWorkflow1() throws Exception {
        ...
        String jsonFile = YamlUtils.cwlFileContentToJson(YamlUtils.readFile(file.getPath(), StandardCharsets.UTF_8));
        ...
        jsonFile = YamlUtils.cwlFileContentToJson(YamlUtils.readFile(file.getPath(), StandardCharsets.UTF_8));
    ...
    public void toolValidateMappingFileToWorkflow() throws Exception {
        ...
        String jsonValidate = YamlUtils.cwlFileContentToJson(YamlUtils.readFile(toolvalidate.getPath(), StandardCharsets.UTF_8));
